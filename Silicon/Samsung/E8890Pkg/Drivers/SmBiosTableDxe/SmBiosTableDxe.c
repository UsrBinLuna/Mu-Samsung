/** @file
  SMBIOS Table for Samsung Exynos 9810 Platforms
...
************************************************************************/
SMBIOS_TABLE_TYPE4 mProcessorInfoType4_m3 = {
...
CHAR8 *mProcessorInfoType4Strings[] = {
    "Samsung", "Samsung Electronics Ltd", "Not Specified", "Not Specified",
    NULL};
...
CHAR8 *mCacheInfoType7Strings[] = {"L2 Instruction", "L2 Data", "L2", NULL};
...
VOID ProcessorInfoUpdateSmbiosType4(VOID)
{
  ...
  LogSmbiosData(
      (EFI_SMBIOS_TABLE_HEADER *)&mProcessorInfoType4_m3,
...
VOID CacheInfoUpdateSmbiosType7(VOID)
{
  ...
  mProcessorInfoType4_m3.L2CacheHandle = (UINT16)SmbiosHandle;
